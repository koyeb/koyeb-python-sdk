...
class CreateArchiveReply(BaseModel):
    """
    CreateArchiveReply
    """ # noqa: E501
    archive: Optional[Archive] = None
    __properties: ClassVar[List[str]] = ["archive"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "archive": Archive.from_dict(obj["archive"]) if obj.get("archive") is not None else None
        })
        return _obj
