...
class UsersApi:
    ...
    def delete_user(
        self,
        id: Annotated[StrictStr, Field(description="The id of the user")],
    ...
    @validate_call
    def delete_user_v2_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="The id of the user")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def delete_user_v2_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="The id of the user")],
        _request_timeout: Union[
            None,
