...
class Secret(BaseModel):
    ...
    project_id: Optional[StrictStr] = Field(default=None, description="The project ID this secret belongs to. Empty if the secret is organization-level.")
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "organization_id", "type", "updated_at", "created_at", "project_id", "value", "docker_hub_registry", "private_registry", "digital_ocean_registry", "github_registry", "gitlab_registry", "gcp_container_registry", "azure_container_registry", "database_role_password"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "database_role_password": DatabaseRolePassword.from_dict(obj["database_role_password"]) if obj.get("database_role_password") is not None else None
        })
        return _obj
