...
from koyeb.api_async.models.create_app import CreateApp
from koyeb.api_async.models.create_app_reply import CreateAppReply
...
async with koyeb.api_async.ApiClient(configuration) as api_client:
    ...
    try:
        # Delete App
        api_response = await api_instance.delete_app(id)
...
async with koyeb.api_async.ApiClient(configuration) as api_client:
    ...
    try:
        # Get App
        api_response = await api_instance.get_app(id)
...
async with koyeb.api_async.ApiClient(configuration) as api_client:
    ...
    try:
        # List App events
        api_response = await api_instance.list_app_events(app_id=app_id, types=types, limit=limit, offset=offset, order=order)
...
```python
import koyeb.api_async
from koyeb.api_async.models.list_apps_reply import ListAppsReply
from koyeb.api_async.rest import ApiException
from pprint import pprint
...
async with koyeb.api_async.ApiClient(configuration) as api_client:
    ...
    try:
        # Pause App
        api_response = await api_instance.pause_app(id)
...
async with koyeb.api_async.ApiClient(configuration) as api_client:
    ...
    try:
        # Resume App
        api_response = await api_instance.resume_app(id)
...
```python
import koyeb.api_async
from koyeb.api_async.models.update_app import UpdateApp
from koyeb.api_async.models.update_app_reply import UpdateAppReply
from koyeb.api_async.rest import ApiException
from pprint import pprint
...
async with koyeb.api_async.ApiClient(configuration) as api_client:
    ...
    app = koyeb.api_async.UpdateApp() # UpdateApp | 
    update_mask = 'update_mask_example' # str |  (optional)

    try:
        # Update App
        api_response = await api_instance.update_app(id, app, update_mask=update_mask)
...
async with koyeb.api_async.ApiClient(configuration) as api_client:
    ...
    try:
        # Update App
        api_response = await api_instance.update_app2(id, app, update_mask=update_mask)
