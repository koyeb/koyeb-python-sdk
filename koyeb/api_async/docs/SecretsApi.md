...
from koyeb.api_async.models.create_secret import CreateSecret
from koyeb.api_async.models.create_secret_reply import CreateSecretReply
...
async with koyeb.api_async.ApiClient(configuration) as api_client:
    ...
    api_instance = koyeb.api_async.SecretsApi(api_client)
    secret = koyeb.api_async.CreateSecret() # CreateSecret | 

    try:
        # Create Secret
        api_response = await api_instance.create_secret(secret)
...
async with koyeb.api_async.ApiClient(configuration) as api_client:
    ...
    try:
        # Delete Secret
        api_response = await api_instance.delete_secret(id)
...
async with koyeb.api_async.ApiClient(configuration) as api_client:
    ...
    try:
        # Get Secret
        api_response = await api_instance.get_secret(id)
...
# **list_secrets**
> ListSecretsReply list_secrets(name=name, limit=limit, offset=offset, types=types, ids=ids)
...
```python
import koyeb.api_async
from koyeb.api_async.models.list_secrets_reply import ListSecretsReply
from koyeb.api_async.rest import ApiException
from pprint import pprint
...
async with koyeb.api_async.ApiClient(configuration) as api_client:
    ...
    ids = ['ids_example'] # List[str] | (Optional) Filter on secret ids (optional)

    try:
        # List Secrets
        api_response = await api_instance.list_secrets(name=name, limit=limit, offset=offset, types=types, ids=ids)
 ...
 **ids** | [**List[str]**](str.md)| (Optional) Filter on secret ids | [optional] 
...
```python
import koyeb.api_async
from koyeb.api_async.models.reveal_secret_reply import RevealSecretReply
from koyeb.api_async.rest import ApiException
from pprint import pprint
...
async with koyeb.api_async.ApiClient(configuration) as api_client:
    ...
    try:
        # Reveal Secret
        api_response = await api_instance.reveal_secret(id, body)
...
```python
import koyeb.api_async
from koyeb.api_async.models.secret import Secret
from koyeb.api_async.models.update_secret_reply import UpdateSecretReply
from koyeb.api_async.rest import ApiException
from pprint import pprint
...
async with koyeb.api_async.ApiClient(configuration) as api_client:
    ...
    api_instance = koyeb.api_async.SecretsApi(api_client)
    id = 'id_example' # str | 
    secret = koyeb.api_async.Secret() # Secret | 
    update_mask = 'update_mask_example' # str |  (optional)

    try:
        # Update Secret
        api_response = await api_instance.update_secret(id, secret, update_mask=update_mask)
...
async with koyeb.api_async.ApiClient(configuration) as api_client:
    ...
    try:
        # Update Secret
        api_response = await api_instance.update_secret2(id, secret, update_mask=update_mask)
