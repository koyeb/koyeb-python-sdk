    ...
    def make_instance(self, include_optional) -> Usage:
        ...
        if include_optional:
            return Usage(
                organization_id = '',
                periods = {
                    'key' : koyeb.api_async.models.period_usage.PeriodUsage(
                        ...
                        apps = [
                            koyeb.api_async.models.app_usage.AppUsage(
                                app_id = '', 
                                app_name = '', 
                                services = [
                                    koyeb.api_async.models.service_usage.ServiceUsage(
                                        service_id = '', 
                                        service_name = '', 
                                        regions = {
                                ...
                                databases = [
                                    koyeb.api_async.models.database_usage.DatabaseUsage(
                                        service_id = '', 
                                        service_name = '', 
