...
from koyeb.api_async.models.autocomplete_reply import AutocompleteReply
...
async with koyeb.api_async.ApiClient(configuration) as api_client:
    ...
    api_instance = koyeb.api_async.ServicesApi(api_client)
    body = koyeb.api_async.AutocompleteRequest() # AutocompleteRequest | 

    try:
        # Autocomplete definition
        api_response = await api_instance.autocomplete(body)
...
from koyeb.api_async.models.create_service_reply import CreateServiceReply
from koyeb.api_async.rest import ApiException
from pprint import pprint
...
async with koyeb.api_async.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = koyeb.api_async.ServicesApi(api_client)
    service = koyeb.api_async.CreateService() # CreateService | 
    dry_run = True # bool | If set only run validation (optional)

    try:
        # Create Service
        api_response = await api_instance.create_service(service, dry_run=dry_run)
...
async with koyeb.api_async.ApiClient(configuration) as api_client:
    ...
    try:
        # Delete Service
        api_response = await api_instance.delete_service(id)
...
async with koyeb.api_async.ApiClient(configuration) as api_client:
    ...
    try:
        # Delete Service Scaling
        api_response = await api_instance.delete_service_scaling(id)
...
```python
import koyeb.api_async
from koyeb.api_async.models.get_service_reply import GetServiceReply
from koyeb.api_async.rest import ApiException
from pprint import pprint
...
async with koyeb.api_async.ApiClient(configuration) as api_client:
    ...
    try:
        # Get Service
        api_response = await api_instance.get_service(id)
...
```python
import koyeb.api_async
from koyeb.api_async.models.get_service_scaling_reply import GetServiceScalingReply
from koyeb.api_async.rest import ApiException
from pprint import pprint
...
async with koyeb.api_async.ApiClient(configuration) as api_client:
    ...
    try:
        # Get Service Scaling
        api_response = await api_instance.get_service_scaling(id)
...
```python
import koyeb.api_async
from koyeb.api_async.models.list_service_events_reply import ListServiceEventsReply
from koyeb.api_async.rest import ApiException
from pprint import pprint
...
async with koyeb.api_async.ApiClient(configuration) as api_client:
    ...
    try:
        # List Service events
        api_response = await api_instance.list_service_events(service_id=service_id, types=types, limit=limit, offset=offset, order=order)
...
```python
import koyeb.api_async
from koyeb.api_async.models.list_services_reply import ListServicesReply
from koyeb.api_async.rest import ApiException
from pprint import pprint
...
async with koyeb.api_async.ApiClient(configuration) as api_client:
    ...
    try:
        # Pause Service
        api_response = await api_instance.pause_service(id)
...
```python
import koyeb.api_async
from koyeb.api_async.models.redeploy_reply import RedeployReply
from koyeb.api_async.models.redeploy_request_info import RedeployRequestInfo
from koyeb.api_async.rest import ApiException
from pprint import pprint
...
async with koyeb.api_async.ApiClient(configuration) as api_client:
    ...
    api_instance = koyeb.api_async.ServicesApi(api_client)
    id = 'id_example' # str | 
    info = koyeb.api_async.RedeployRequestInfo() # RedeployRequestInfo | 

    try:
        # ReDeploy Service
        api_response = await api_instance.re_deploy(id, info)
...
async with koyeb.api_async.ApiClient(configuration) as api_client:
    ...
    try:
        # Resume Service
        api_response = await api_instance.resume_service(id, skip_build=skip_build, use_cache=use_cache)
...
```python
import koyeb.api_async
from koyeb.api_async.models.update_service import UpdateService
from koyeb.api_async.models.update_service_reply import UpdateServiceReply
from koyeb.api_async.rest import ApiException
from pprint import pprint
...
async with koyeb.api_async.ApiClient(configuration) as api_client:
    ...
    service = koyeb.api_async.UpdateService() # UpdateService | 
    ...
    try:
        # Update Service
        api_response = await api_instance.update_service(id, service, update_mask=update_mask, dry_run=dry_run)
...
async with koyeb.api_async.ApiClient(configuration) as api_client:
    ...
    try:
        # Update Service
        api_response = await api_instance.update_service2(id, service, update_mask=update_mask, dry_run=dry_run)
...
```python
import koyeb.api_async
from koyeb.api_async.models.update_service_scaling_request import UpdateServiceScalingRequest
from koyeb.api_async.rest import ApiException
from pprint import pprint
...
async with koyeb.api_async.ApiClient(configuration) as api_client:
    ...
    body = koyeb.api_async.UpdateServiceScalingRequest() # UpdateServiceScalingRequest | 

    try:
        # Update Service Scaling
        api_response = await api_instance.update_service_scaling(id, body)
