...
class AppsApi:
    ...
    @validate_call
    async def create_app_with_http_info(
        self,
        app: CreateApp,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def create_app_without_preload_content(
        self,
        app: CreateApp,
        _request_timeout: Union[
            None,
    ...
    async def list_app_events(
        self,
        app_id: Annotated[
            Optional[StrictStr], Field(description="(Optional) Filter on app id")
        ] = None,
        types: Annotated[
            Optional[List[StrictStr]],
            Field(description="(Optional) Filter on app event types"),
        ] = None,
        limit: Annotated[
            Optional[StrictStr],
    ...
    @validate_call
    async def list_app_events_with_http_info(
        self,
        app_id: Annotated[
            Optional[StrictStr], Field(description="(Optional) Filter on app id")
        ] = None,
    ...
    @validate_call
    async def list_app_events_without_preload_content(
        self,
        app_id: Annotated[
            Optional[StrictStr], Field(description="(Optional) Filter on app id")
        ] = None,
    ...
    async def list_apps(
        ...
        ids: Annotated[
            Optional[List[StrictStr]], Field(description="(Optional) Filter on app ids")
        ] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    async def pause_app_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="The id of the app to pause.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def pause_app_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="The id of the app to pause.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def resume_app_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="The id of the app to resume.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def resume_app_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="The id of the app to resume.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def update_app2_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="The id of the app to update.")],
        app: UpdateApp,
        update_mask: Optional[StrictStr] = None,
    ...
    @validate_call
    async def update_app2_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="The id of the app to update.")],
        app: UpdateApp,
        update_mask: Optional[StrictStr] = None,
