...
with koyeb.api.ApiClient(configuration) as api_client:
    ...
    api_instance = koyeb.api.CredentialsApi(api_client)
    credential = koyeb.api.CreateCredential() # CreateCredential | 
...
with koyeb.api.ApiClient(configuration) as api_client:
    ...
    api_instance = koyeb.api.CredentialsApi(api_client)
    id = 'id_example' # str | 
    credential = koyeb.api.Credential() # Credential | 
