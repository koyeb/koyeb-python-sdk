...
from koyeb.api_async.models.get_organization_summary_reply import GetOrganizationSummaryReply
...
async with koyeb.api_async.ApiClient(configuration) as api_client:
    ...
    api_instance = koyeb.api_async.SummaryApi(api_client)
    organization_id = 'organization_id_example' # str | Organization ID

    try:
        # Get organization usage summary
        api_response = await api_instance.get_organization_summary(organization_id)
