...
with koyeb.api.ApiClient(configuration) as api_client:
    ...
    api_instance = koyeb.api.DeploymentsApi(api_client)
...
with koyeb.api.ApiClient(configuration) as api_client:
    ...
    try:
        # List Deployments
        api_response = api_instance.list_deployments(app_id=app_id, service_id=service_id, limit=limit, offset=offset, statuses=statuses, ids=ids)
