...
from koyeb.api_async.models.has_unpaid_invoices_reply import HasUnpaidInvoicesReply
...
async with koyeb.api_async.ApiClient(configuration) as api_client:
    ...
    api_instance = koyeb.api_async.BillingApi(api_client)

    try:
        # Experimental: Has unpaid invoices
        api_response = await api_instance.has_unpaid_invoices()
...
```python
import koyeb.api_async
from koyeb.api_async.models.manage_reply import ManageReply
from koyeb.api_async.rest import ApiException
from pprint import pprint
...
async with koyeb.api_async.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.manage()
...
async with koyeb.api_async.ApiClient(configuration) as api_client:
    ...
    try:
        # Experimental: Fetch next invoice
        api_response = await api_instance.next_invoice()
