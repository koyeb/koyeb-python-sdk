...
class UpdateOrganizationDefaultProjectRequest(BaseModel):
    """
    UpdateOrganizationDefaultProjectRequest
    """  # noqa: E501

    default_project_id: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["default_project_id"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({"default_project_id": obj.get("default_project_id")})
        return _obj
