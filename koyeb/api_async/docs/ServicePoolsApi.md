# koyeb.api_async.ServicePoolsApi
...
async with koyeb.api_async.ApiClient(configuration) as api_client:
    ...
    api_instance = koyeb.api_async.ServicePoolsApi(api_client)
    service_pool = koyeb.api_async.CreateServicePool() # CreateServicePool | 

    try:
        # Create a ServicePool
        api_response = await api_instance.create_service_pool(service_pool)
...
async with koyeb.api_async.ApiClient(configuration) as api_client:
    ...
    try:
        # Delete a ServicePool
        api_response = await api_instance.delete_service_pool(id)
...
async with koyeb.api_async.ApiClient(configuration) as api_client:
    ...
    try:
        # Get a ServicePool
        api_response = await api_instance.get_service_pool(id)
...
async with koyeb.api_async.ApiClient(configuration) as api_client:
    ...
    try:
        # List ServicePools
        api_response = await api_instance.list_service_pools(name=name, limit=limit, offset=offset)
...
```python
import koyeb.api_async
from koyeb.api_async.models.update_service_pool import UpdateServicePool
...
async with koyeb.api_async.ApiClient(configuration) as api_client:
    ...
    api_instance = koyeb.api_async.ServicePoolsApi(api_client)
    id = 'id_example' # str | 
    service_pool = koyeb.api_async.UpdateServicePool() # UpdateServicePool | 
    update_mask = 'update_mask_example' # str |  (optional)

    try:
        api_response = await api_instance.update_service_pool(id, service_pool, update_mask=update_mask)
