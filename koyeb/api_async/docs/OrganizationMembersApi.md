# koyeb.api_async.OrganizationMembersApi
...
from koyeb.api_async.models.list_organization_members_reply import ListOrganizationMembersReply
...
async with koyeb.api_async.ApiClient(configuration) as api_client:
    ...
    api_instance = koyeb.api_async.OrganizationMembersApi(api_client)
    ...
    try:
        # List organization members
        api_response = await api_instance.list_organization_members(limit=limit, offset=offset, organization_id=organization_id, user_id=user_id, organization_statuses=organization_statuses)
...
```python
import koyeb.api_async
from koyeb.api_async.models.remove_organization_member_reply import RemoveOrganizationMemberReply
from koyeb.api_async.rest import ApiException
from pprint import pprint
...
async with koyeb.api_async.ApiClient(configuration) as api_client:
    ...
    try:
        # Remove an organization member
        api_response = await api_instance.remove_organization_member(id)
