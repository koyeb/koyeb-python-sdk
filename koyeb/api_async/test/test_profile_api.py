...
class TestProfileApi(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_accept_organization_invitation(self) -> None:
    ...
    async def test_clear_idenfy_verification_result(self) -> None:
    ...
    async def test_decline_organization_invitation(self) -> None:
    ...
    async def test_get_current_organization(self) -> None:
    ...
    async def test_get_idenfy_token(self) -> None:
    ...
    async def test_get_o_auth_options(self) -> None:
    ...
    async def test_get_user_organization_invitation(self) -> None:
    ...
    async def test_list_user_organizations(self) -> None:
    ...
    async def test_login_method(self) -> None:
    ...
    async def test_o_auth_callback(self) -> None:
    ...
    async def test_resend_email_validation(self) -> None:
    ...
    async def test_update_user2(self) -> None:
    ...
    async def test_update_user_v22(self) -> None:
