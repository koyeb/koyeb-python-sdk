...
class PoolClaimReply(BaseModel):
    ...
    PoolClaimReply
    """ # noqa: E501
    claim_id: Optional[StrictStr] = None
    service_id: Optional[StrictStr] = None
    prewarmed: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["claim_id", "service_id", "prewarmed"]
