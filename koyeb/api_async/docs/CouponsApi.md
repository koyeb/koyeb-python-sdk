...
from koyeb.api_async.models.check_coupon_reply import CheckCouponReply
...
async with koyeb.api_async.ApiClient(configuration) as api_client:
    ...
    api_instance = koyeb.api_async.CouponsApi(api_client)
    code = 'code_example' # str | 

    try:
        # Check Coupon
        api_response = await api_instance.check_coupon(code)
...
async with koyeb.api_async.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = koyeb.api_async.CouponsApi(api_client)
    body = koyeb.api_async.RedeemCouponRequest() # RedeemCouponRequest | 

    try:
        # Redeem Coupon
        api_response = await api_instance.redeem_coupon(body)
