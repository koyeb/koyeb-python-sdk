...
with koyeb.api.ApiClient(configuration) as api_client:
    ...
    api_instance = koyeb.api.DomainsApi(api_client)
    domain = koyeb.api.CreateDomain() # CreateDomain | 
...
with koyeb.api.ApiClient(configuration) as api_client:
    ...
    try:
        # List Domains
        api_response = api_instance.list_domains(limit=limit, offset=offset, types=types, statuses=statuses, app_ids=app_ids, name=name, ids=ids)
...
with koyeb.api.ApiClient(configuration) as api_client:
    ...
    api_instance = koyeb.api.DomainsApi(api_client)
    id = 'id_example' # str | 
    domain = koyeb.api.UpdateDomain() # UpdateDomain | 
