...
class CatalogRegionsApi:
    ...
    async def get_region(
        self,
        id: Annotated[StrictStr, Field(description="The name of the region")],
        ...
        :param id: The name of the region (required)
        :type id: str
    ...
    @validate_call
    async def get_region_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="The name of the region")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def get_region_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="The name of the region")],
        _request_timeout: Union[
            None,
    ...
    async def list_regions(
        ...
        :type offset: str
        :param id: (Optional) A filter for regions
        :type id: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
