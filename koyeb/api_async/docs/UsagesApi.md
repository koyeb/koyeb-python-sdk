...
async with koyeb.api_async.ApiClient(configuration) as api_client:
    ...
    api_instance = koyeb.api_async.UsagesApi(api_client)
    ...
    try:
        # Get organization usage
        api_response = await api_instance.get_organization_usage(starting_time=starting_time, ending_time=ending_time)
...
async with koyeb.api_async.ApiClient(configuration) as api_client:
    ...
    try:
        # Get organization usage details
        api_response = await api_instance.get_organization_usage_details(starting_time=starting_time, ending_time=ending_time, limit=limit, offset=offset, order=order, accept=accept)
