...
class Configuration:
    ...
    def __init__(
        ...
        *,
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("koyeb.api")
    ...
    def to_debug_report(self) -> str:
        ...
        return (
            ...
            "SDK Package Version: 1.3.3".format(env=sys.platform, pyversion=sys.version)
        )
