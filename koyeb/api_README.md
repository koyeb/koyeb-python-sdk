...
*PoolClaimsApi* | [**claim**](koyeb/api/docs/PoolClaimsApi.md#claim) | **POST** /v1/claim | Claim a sandbox from a service pool
*PoolClaimsApi* | [**get_claim**](koyeb/api/docs/PoolClaimsApi.md#get_claim) | **GET** /v1/claims/{claim_id} | Get a claim
*PoolClaimsApi* | [**list_claim**](koyeb/api/docs/PoolClaimsApi.md#list_claim) | **GET** /v1/service_pools/{pool_id}/claims | List claims of a service pool
...
*QuotasApi* | [**get_organization_quotas_usage**](koyeb/api/docs/QuotasApi.md#get_organization_quotas_usage) | **GET** /v1/quotas/organizations/{organization_id}/usage | Return the organization&#39;s current quota usage alongside the plan&#39;s limits. Response is cached in Redis for 60s. Accept text/plain (or ?format&#x3D;prometheus) to receive the response rendered as Prometheus text exposition format (\&quot;koyeb_quota_&lt;x&gt;\&quot; for usage, \&quot;koyeb_quota_&lt;x&gt;_limit\&quot; for the plan limit) suitable for scraping into an external Prometheus.
...
*ServicePoolsApi* | [**create_service_pool**](koyeb/api/docs/ServicePoolsApi.md#create_service_pool) | **POST** /v1/service_pools | Create a ServicePool
*ServicePoolsApi* | [**delete_service_pool**](koyeb/api/docs/ServicePoolsApi.md#delete_service_pool) | **DELETE** /v1/service_pools/{id} | Delete a ServicePool
*ServicePoolsApi* | [**get_service_pool**](koyeb/api/docs/ServicePoolsApi.md#get_service_pool) | **GET** /v1/service_pools/{id} | Get a ServicePool
*ServicePoolsApi* | [**list_service_pools**](koyeb/api/docs/ServicePoolsApi.md#list_service_pools) | **GET** /v1/service_pools | List ServicePools
*ServicePoolsApi* | [**update_service_pool**](koyeb/api/docs/ServicePoolsApi.md#update_service_pool) | **PUT** /v1/service_pools/{id} | 
...
## Documentation For Models
 ...
 - [CreateServicePool](koyeb/api/docs/CreateServicePool.md)
 - [CreateServicePoolReply](koyeb/api/docs/CreateServicePoolReply.md)
 ...
 - [GetOrganizationQuotasUsageReply](koyeb/api/docs/GetOrganizationQuotasUsageReply.md)
 ...
 - [GetPoolClaimReply](koyeb/api/docs/GetPoolClaimReply.md)
 ...
 - [GetServicePoolReply](koyeb/api/docs/GetServicePoolReply.md)
 ...
 - [InstanceSnapshotTypeUsage](koyeb/api/docs/InstanceSnapshotTypeUsage.md)
 - [InstanceStatus](koyeb/api/docs/InstanceStatus.md)
 - [InstanceTypeUsage](koyeb/api/docs/InstanceTypeUsage.md)
 ...
 - [ListPoolClaimReply](koyeb/api/docs/ListPoolClaimReply.md)
 ...
 - [ListServicePoolsReply](koyeb/api/docs/ListServicePoolsReply.md)
 ...
 - [Mesh](koyeb/api/docs/Mesh.md)
 - [MeshScope](koyeb/api/docs/MeshScope.md)
 ...
 - [PersistentVolumeRegionUsage](koyeb/api/docs/PersistentVolumeRegionUsage.md)
 - [PersistentVolumeStatus](koyeb/api/docs/PersistentVolumeStatus.md)
 - [Plan](koyeb/api/docs/Plan.md)
 - [PoolClaim](koyeb/api/docs/PoolClaim.md)
 - [PoolClaimReply](koyeb/api/docs/PoolClaimReply.md)
 - [PoolClaimRequest](koyeb/api/docs/PoolClaimRequest.md)
 - [PoolClaimStatus](koyeb/api/docs/PoolClaimStatus.md)
 ...
 - [QuotaUsage](koyeb/api/docs/QuotaUsage.md)
 ...
 - [ServicePool](koyeb/api/docs/ServicePool.md)
 - [ServicePoolStatus](koyeb/api/docs/ServicePoolStatus.md)
 ...
 - [UpdateServicePool](koyeb/api/docs/UpdateServicePool.md)
 - [UpdateServicePoolReply](koyeb/api/docs/UpdateServicePoolReply.md)
