# koyeb.api_async.CatalogRegionsApi
...
async with koyeb.api_async.ApiClient(configuration) as api_client:
    ...
    api_instance = koyeb.api_async.CatalogRegionsApi(api_client)
    id = 'id_example' # str | The name of the region

    try:
        # Get Region
        api_response = await api_instance.get_region(id)
...
```python
import koyeb.api_async
from koyeb.api_async.models.list_regions_reply import ListRegionsReply
from koyeb.api_async.rest import ApiException
from pprint import pprint
...
async with koyeb.api_async.ApiClient(configuration) as api_client:
    ...
    try:
        # List Region
        api_response = await api_instance.list_regions(limit=limit, offset=offset, id=id)
