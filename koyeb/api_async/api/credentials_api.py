...
class CredentialsApi:
    ...
    async def list_credentials(
        self,
        type: Annotated[
            Optional[StrictStr], Field(description="(Optional) A filter for type")
        ] = None,
        name: Annotated[
        ...
        organization_id: Annotated[
            Optional[StrictStr],
            Field(description="(Optional) Filter for an organization"),
        ] = None,
        user_id: Annotated[
    ...
    @validate_call
    async def update_credential2_with_http_info(
        self,
        id: StrictStr,
        credential: Credential,
        update_mask: Optional[StrictStr] = None,
    ...
    @validate_call
    async def update_credential2_without_preload_content(
        self,
        id: StrictStr,
        credential: Credential,
        update_mask: Optional[StrictStr] = None,
