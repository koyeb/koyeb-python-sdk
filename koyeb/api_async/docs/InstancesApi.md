...
async with koyeb.api_async.ApiClient(configuration) as api_client:
    ...
    api_instance = koyeb.api_async.InstancesApi(api_client)
    ...
    try:
        # Exec Command
        api_response = await api_instance.exec_command(id=id, body_command=body_command, body_tty_size_height=body_tty_size_height, body_tty_size_width=body_tty_size_width, body_stdin_data=body_stdin_data, body_stdin_close=body_stdin_close, body_disable_tty=body_disable_tty, id_type=id_type)
...
async with koyeb.api_async.ApiClient(configuration) as api_client:
    ...
    try:
        # Get Instance
        api_response = await api_instance.get_instance(id)
...
```python
import koyeb.api_async
from koyeb.api_async.models.list_instance_events_reply import ListInstanceEventsReply
from koyeb.api_async.rest import ApiException
from pprint import pprint
...
async with koyeb.api_async.ApiClient(configuration) as api_client:
    ...
    try:
        # List Instance events
        api_response = await api_instance.list_instance_events(instance_ids=instance_ids, types=types, limit=limit, offset=offset, order=order)
