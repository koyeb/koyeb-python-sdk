...
from koyeb.api_async.models.activity_list import ActivityList
...
async with koyeb.api_async.ApiClient(configuration) as api_client:
    ...
    api_instance = koyeb.api_async.ActivityApi(api_client)
    limit = 'limit_example' # str |  (optional)
    offset = 'offset_example' # str |  (optional)

    try:
        api_response = await api_instance.get_account_activities(limit=limit, offset=offset)
...
async with koyeb.api_async.ApiClient(configuration) as api_client:
    ...
    try:
        # List Activities
        api_response = await api_instance.list_activities(limit=limit, offset=offset, types=types)
...
```python
import koyeb.api_async
from koyeb.api_async.models.notification_list import NotificationList
from koyeb.api_async.rest import ApiException
from pprint import pprint
...
async with koyeb.api_async.ApiClient(configuration) as api_client:
    ...
    try:
        # List Notifications
        api_response = await api_instance.list_notifications(limit=limit, offset=offset, mark_read=mark_read, mark_seen=mark_seen, unread=unread, unseen=unseen)
