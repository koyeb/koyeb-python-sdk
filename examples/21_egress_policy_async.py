...
async def main():
    ...
    try:
        ...
        await wait_for_probe(sandbox, PROBE, False, "block_network=True → example.com")
        ...
        await wait_for_probe(
            sandbox, PROBE, False, "allowlist=[1.1.1.1, ...] → example.com"
        )
        ...
        await wait_for_probe(sandbox, PROBE, True, "default → example.com")
