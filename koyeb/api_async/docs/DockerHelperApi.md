# koyeb.api_async.DockerHelperApi
...
from koyeb.api_async.models.verify_docker_image_reply import VerifyDockerImageReply
...
async with koyeb.api_async.ApiClient(configuration) as api_client:
    ...
    api_instance = koyeb.api_async.DockerHelperApi(api_client)
    ...
    try:
        # Verify Docker Image
        api_response = await api_instance.verify_docker_image(image=image, secret_id=secret_id)
