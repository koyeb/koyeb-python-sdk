...
class ListPersistentVolumeEventsReply(BaseModel):
    """
    ListPersistentVolumeEventsReply
    """ # noqa: E501
    events: Optional[List[PersistentVolumeEvent]] = None
    limit: Optional[StrictInt] = None
    offset: Optional[StrictInt] = None
    order: Optional[StrictStr] = None
    has_next: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["events", "limit", "offset", "order", "has_next"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "events": [PersistentVolumeEvent.from_dict(_item) for _item in obj["events"]] if obj.get("events") is not None else None,
            "limit": obj.get("limit"),
