...
from koyeb.api_async.models.get_intercom_profile_reply import GetIntercomProfileReply
...
async with koyeb.api_async.ApiClient(configuration) as api_client:
    ...
    api_instance = koyeb.api_async.IntercomApi(api_client)

    try:
        # Get intercom profile
        api_response = await api_instance.get_intercom_profile()
