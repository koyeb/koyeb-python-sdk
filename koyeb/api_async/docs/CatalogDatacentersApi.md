# koyeb.api_async.CatalogDatacentersApi
...
from koyeb.api_async.models.list_datacenters_reply import ListDatacentersReply
...
async with koyeb.api_async.ApiClient(configuration) as api_client:
    ...
    api_instance = koyeb.api_async.CatalogDatacentersApi(api_client)

    try:
        # List datacenters
        api_response = await api_instance.list_datacenters()
