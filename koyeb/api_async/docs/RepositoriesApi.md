# koyeb.api_async.RepositoriesApi
...
from koyeb.api_async.models.kgitproxy_list_branches_reply import KgitproxyListBranchesReply
...
async with koyeb.api_async.ApiClient(configuration) as api_client:
    ...
    api_instance = koyeb.api_async.RepositoriesApi(api_client)
    ...
    try:
        # List Branches
        api_response = await api_instance.list_branches(repository_id=repository_id, name=name, limit=limit, offset=offset)
...
```python
import koyeb.api_async
from koyeb.api_async.models.kgitproxy_list_repositories_reply import KgitproxyListRepositoriesReply
from koyeb.api_async.rest import ApiException
from pprint import pprint
...
async with koyeb.api_async.ApiClient(configuration) as api_client:
    ...
    try:
        # List Repositories
        api_response = await api_instance.list_repositories(name=name, name_search_op=name_search_op, limit=limit, offset=offset)
...
async with koyeb.api_async.ApiClient(configuration) as api_client:
    ...
    try:
        # Resync Organization
        api_response = await api_instance.resync_organization(organization_id)
