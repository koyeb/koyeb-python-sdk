...
class TestUpdateOrganizationNameReply(unittest.TestCase):
    """UpdateOrganizationNameReply unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateOrganizationNameReply:
        """Test UpdateOrganizationNameReply
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateOrganizationNameReply`
        """
        model = UpdateOrganizationNameReply()
        if include_optional:
    ...
    def testUpdateOrganizationNameReply(self):
        """Test UpdateOrganizationNameReply"""
