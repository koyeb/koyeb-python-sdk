# koyeb.api.InstanceSnapshotsApi
...
with koyeb.api.ApiClient(configuration) as api_client:
    ...
    api_instance = koyeb.api.InstanceSnapshotsApi(api_client)
    body = koyeb.api.CreateInstanceSnapshotRequest() # CreateInstanceSnapshotRequest | 

    try:
        api_response = api_instance.create_instance_snapshot(body)
...
with koyeb.api.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.delete_instance_snapshot(id)
...
with koyeb.api.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.get_instance_snapshot(id)
...
with koyeb.api.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.list_instance_snapshot_events(instance_snapshot_id=instance_snapshot_id, types=types, limit=limit, offset=offset, order=order)
