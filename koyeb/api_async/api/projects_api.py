...
class ProjectsApi:
    ...
    async def create_project_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[CreateProjectReply]:
        """Create project
    ...
    async def list_projects(
        ...
        name: Annotated[Optional[StrictStr], Field(description="(Optional) Filter by project name")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
    ...
    async def update_project_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[UpdateProjectReply]:
        """Update project
    ...
    async def update_project2(
        ...
        _param = self._update_project2_serialize(
            id=id,
            project=project,
            update_mask=update_mask,
            _request_auth=_request_auth,
    ...
    @validate_call
    async def update_project2_with_http_info(
        self,
        id: StrictStr,
        project: Project,
        update_mask: Optional[StrictStr] = None,
    ...
    @validate_call
    async def update_project2_without_preload_content(
        self,
        id: StrictStr,
        project: Project,
        update_mask: Optional[StrictStr] = None,
    ...
    def _update_project2_serialize(
        self,
        id,
        project,
        update_mask,
