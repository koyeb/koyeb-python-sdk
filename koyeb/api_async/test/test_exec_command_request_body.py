    ...
    def make_instance(self, include_optional) -> ExecCommandRequestBody:
        ...
        if include_optional:
            return ExecCommandRequestBody(
                ...
                tty_size = koyeb.api_async.models.exec_command_request/terminal_size.ExecCommandRequest.TerminalSize(
                    height = 56, 
                    width = 56, ),
                stdin = koyeb.api_async.models.exec_command_io.ExecCommandIO(
                    data = 'YQ==', 
                    close = True, ),
                disable_tty = True
            )
