# koyeb.api_async.OrganizationQuotasApi
...
from koyeb.api_async.models.get_quotas_reply import GetQuotasReply
...
async with koyeb.api_async.ApiClient(configuration) as api_client:
    ...
    api_instance = koyeb.api_async.OrganizationQuotasApi(api_client)
    organization_id = 'organization_id_example' # str | 

    try:
        api_response = await api_instance.get_quotas(organization_id)
