    ...
    def make_instance(self, include_optional) -> NextInvoiceReply:
        ...
        if include_optional:
            return NextInvoiceReply(
                stripe_invoice = None,
                lines = [
                    koyeb.api_async.models.next_invoice_reply/line.NextInvoiceReply.Line(
                        amount_excluding_tax = 56, 
                        period = koyeb.api_async.models.next_invoice_reply/line/period.NextInvoiceReply.Line.Period(
                            start = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                            end = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), ), 
                        plan_nickname = '', 
                        price = koyeb.api_async.models.next_invoice_reply/line/price.NextInvoiceReply.Line.Price(
                            unit_amount_decimal = 1.337, ), 
                        quantity = 56, )
                    ],
                discounts = [
                    koyeb.api_async.models.next_invoice_reply/discount.NextInvoiceReply.Discount(
                        type = 'PERCENT_OFF', 
                        name = '', 
                        amount = '', )
                    ]
