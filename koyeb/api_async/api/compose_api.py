...
class ComposeApi:
    ...
    async def compose(
        ...
        _param = self._compose_serialize(
            compose=compose,
    ...
    @validate_call
    async def compose_with_http_info(
        self,
        compose: CreateCompose,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def compose_without_preload_content(
        self,
        compose: CreateCompose,
        _request_timeout: Union[
            None,
