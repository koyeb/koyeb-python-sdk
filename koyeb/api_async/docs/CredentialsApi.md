# koyeb.api_async.CredentialsApi
...
from koyeb.api_async.models.create_credential import CreateCredential
from koyeb.api_async.models.create_credential_reply import CreateCredentialReply
...
async with koyeb.api_async.ApiClient(configuration) as api_client:
    ...
    credential = koyeb.api_async.CreateCredential() # CreateCredential | 

    try:
        # Create credential
        api_response = await api_instance.create_credential(credential)
...
async with koyeb.api_async.ApiClient(configuration) as api_client:
    ...
    try:
        # Delete credential
        api_response = await api_instance.delete_credential(id)
...
```python
import koyeb.api_async
from koyeb.api_async.models.get_credential_reply import GetCredentialReply
from koyeb.api_async.rest import ApiException
from pprint import pprint
...
async with koyeb.api_async.ApiClient(configuration) as api_client:
    ...
    try:
        # Get credential
        api_response = await api_instance.get_credential(id)
...
```python
import koyeb.api_async
from koyeb.api_async.models.list_credentials_reply import ListCredentialsReply
from koyeb.api_async.rest import ApiException
from pprint import pprint
...
async with koyeb.api_async.ApiClient(configuration) as api_client:
    ...
    try:
        # List credentials
        api_response = await api_instance.list_credentials(type=type, name=name, organization_id=organization_id, user_id=user_id, limit=limit, offset=offset)
...
```python
import koyeb.api_async
from koyeb.api_async.models.credential import Credential
...
async with koyeb.api_async.ApiClient(configuration) as api_client:
    ...
    api_instance = koyeb.api_async.CredentialsApi(api_client)
    id = 'id_example' # str | 
    credential = koyeb.api_async.Credential() # Credential | 
    update_mask = 'update_mask_example' # str |  (optional)

    try:
        # Update credential
        api_response = await api_instance.update_credential(id, credential, update_mask=update_mask)
...
async with koyeb.api_async.ApiClient(configuration) as api_client:
    ...
    try:
        # Update credential
        api_response = await api_instance.update_credential2(id, credential, update_mask=update_mask)
