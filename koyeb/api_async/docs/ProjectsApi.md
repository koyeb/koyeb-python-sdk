...
from koyeb.api_async.models.create_project import CreateProject
from koyeb.api_async.models.create_project_reply import CreateProjectReply
...
async with koyeb.api_async.ApiClient(configuration) as api_client:
    ...
    api_instance = koyeb.api_async.ProjectsApi(api_client)
    project = koyeb.api_async.CreateProject() # CreateProject | 
...
async with koyeb.api_async.ApiClient(configuration) as api_client:
    ...
    try:
        # Delete project
        api_response = await api_instance.delete_project(id)
...
```python
import koyeb.api_async
from koyeb.api_async.models.get_project_reply import GetProjectReply
from koyeb.api_async.rest import ApiException
from pprint import pprint
...
async with koyeb.api_async.ApiClient(configuration) as api_client:
    ...
    try:
        # Get project
        api_response = await api_instance.get_project(id)
...
```python
import koyeb.api_async
from koyeb.api_async.models.list_projects_reply import ListProjectsReply
from koyeb.api_async.rest import ApiException
from pprint import pprint
...
async with koyeb.api_async.ApiClient(configuration) as api_client:
    ...
    try:
        # List projects
        api_response = await api_instance.list_projects(limit=limit, offset=offset, name=name)
...
```python
import koyeb.api_async
from koyeb.api_async.models.project import Project
from koyeb.api_async.models.update_project_reply import UpdateProjectReply
from koyeb.api_async.rest import ApiException
from pprint import pprint
...
async with koyeb.api_async.ApiClient(configuration) as api_client:
    ...
    api_instance = koyeb.api_async.ProjectsApi(api_client)
    id = 'id_example' # str | 
    project = koyeb.api_async.Project() # Project | 
    update_mask = 'update_mask_example' # str |  (optional)

    try:
        # Update project
        api_response = await api_instance.update_project(id, project, update_mask=update_mask)
...
async with koyeb.api_async.ApiClient(configuration) as api_client:
    ...
    try:
        # Update project
        api_response = await api_instance.update_project2(id, project, update_mask=update_mask)
