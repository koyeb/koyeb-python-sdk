...
from koyeb.api_async.models.create_domain_reply import CreateDomainReply
...
async with koyeb.api_async.ApiClient(configuration) as api_client:
    ...
    api_instance = koyeb.api_async.DomainsApi(api_client)
    domain = koyeb.api_async.CreateDomain() # CreateDomain | 

    try:
        # Create Domain
        api_response = await api_instance.create_domain(domain)
...
async with koyeb.api_async.ApiClient(configuration) as api_client:
    ...
    try:
        # Delete Domain
        api_response = await api_instance.delete_domain(id)
...
```python
import koyeb.api_async
from koyeb.api_async.models.get_domain_reply import GetDomainReply
from koyeb.api_async.rest import ApiException
from pprint import pprint
...
async with koyeb.api_async.ApiClient(configuration) as api_client:
    ...
    try:
        # Get Domain
        api_response = await api_instance.get_domain(id)
...
# **list_domains**
> ListDomainsReply list_domains(limit=limit, offset=offset, types=types, statuses=statuses, app_ids=app_ids, name=name, ids=ids)
...
```python
import koyeb.api_async
from koyeb.api_async.models.list_domains_reply import ListDomainsReply
from koyeb.api_async.rest import ApiException
from pprint import pprint
...
async with koyeb.api_async.ApiClient(configuration) as api_client:
    ...
    ids = ['ids_example'] # List[str] | (Optional) Filter on domain ids (optional)

    try:
        # List Domains
        api_response = await api_instance.list_domains(limit=limit, offset=offset, types=types, statuses=statuses, app_ids=app_ids, name=name, ids=ids)
 ...
 **ids** | [**List[str]**](str.md)| (Optional) Filter on domain ids | [optional] 
...
async with koyeb.api_async.ApiClient(configuration) as api_client:
    ...
    try:
        # Refresh Domain Status
        api_response = await api_instance.refresh_domain_status(id)
...
```python
import koyeb.api_async
from koyeb.api_async.models.update_domain import UpdateDomain
from koyeb.api_async.models.update_domain_reply import UpdateDomainReply
from koyeb.api_async.rest import ApiException
from pprint import pprint
...
async with koyeb.api_async.ApiClient(configuration) as api_client:
    ...
    api_instance = koyeb.api_async.DomainsApi(api_client)
    id = 'id_example' # str | 
    domain = koyeb.api_async.UpdateDomain() # UpdateDomain | 
    ...
    try:
        # Update Domain
        api_response = await api_instance.update_domain(id, domain, update_mask=update_mask, dry_run=dry_run)
