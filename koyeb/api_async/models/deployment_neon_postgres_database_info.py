...
class DeploymentNeonPostgresDatabaseInfo(BaseModel):
    ...
    data_transfer_bytes: Optional[StrictStr] = None
    data_storage_bytes_hour: Optional[StrictStr] = None
    server_host: Optional[StrictStr] = None
    server_port: Optional[StrictInt] = None
    endpoint_state: Optional[StrictStr] = None
    endpoint_last_active: Optional[datetime] = None
    default_branch_id: Optional[StrictStr] = None
    default_branch_name: Optional[StrictStr] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "roles": [DeploymentNeonPostgresDatabaseInfoRole.from_dict(_item) for _item in obj["roles"]] if obj.get("roles") is not None else None
        })
        return _obj
