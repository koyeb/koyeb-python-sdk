# koyeb.api_async.SubscriptionsApi
...
from koyeb.api_async.models.get_subscription_reply import GetSubscriptionReply
...
async with koyeb.api_async.ApiClient(configuration) as api_client:
    ...
    api_instance = koyeb.api_async.SubscriptionsApi(api_client)
    id = 'id_example' # str | The id of the instance

    try:
        # Get Subscription
        api_response = await api_instance.get_subscription(id)
