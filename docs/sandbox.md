...
<a id="koyeb/sandbox.test_service_pool"></a>

# koyeb/sandbox.test\_service\_pool
...
<a id="koyeb/sandbox.test_utils.TestGetApiClients"></a>

## TestGetApiClients Objects
...
<a id="koyeb/sandbox.service_pool"></a>

# koyeb/sandbox.service\_pool
...
<a id="koyeb/sandbox.service_pool.ServicePool"></a>
...
<a id="koyeb/sandbox.service_pool.ServicePool.create"></a>
...
<a id="koyeb/sandbox.service_pool.ServicePool.get"></a>
...
<a id="koyeb/sandbox.service_pool.ServicePool.list"></a>
...
def list(cls,
         *,
         ...
         api_token: Optional[str] = None,
         host: Optional[str] = None) -> List["ServicePool"]
```
...
<a id="koyeb/sandbox.service_pool.ServicePool.update"></a>
...
def update(*,
           ...
           size: Optional[int] = None) -> "ServicePool"
```
...
<a id="koyeb/sandbox.service_pool.ServicePool.delete"></a>
...
<a id="koyeb/sandbox.service_pool.ServicePool.refresh"></a>
...
<a id="koyeb/sandbox.service_pool.AsyncServicePool"></a>
...
<a id="koyeb/sandbox.service_pool.AsyncServicePool.create"></a>
...
async def create(cls,
                 ...
                 *,
                 api_token: Optional[str] = None,
                 host: Optional[str] = None) -> "AsyncServicePool"
```
...
<a id="koyeb/sandbox.service_pool.AsyncServicePool.get"></a>
...
<a id="koyeb/sandbox.service_pool.AsyncServicePool.list"></a>
...
async def list(cls,
               *,
               ...
               offset: Optional[int] = None,
               api_token: Optional[str] = None,
               host: Optional[str] = None) -> List["AsyncServicePool"]
```
...
<a id="koyeb/sandbox.service_pool.AsyncServicePool.update"></a>
...
async def update(*,
                 definition: DefinitionInput,
                 size: Optional[int] = None) -> "AsyncServicePool"
```
...
<a id="koyeb/sandbox.service_pool.AsyncServicePool.delete"></a>
...
<a id="koyeb/sandbox.service_pool.AsyncServicePool.refresh"></a>

#### refresh

```python
async def refresh() -> "AsyncServicePool"
```
