...
class DomainsApi:
    ...
    async def list_domains(
        ...
        types: Annotated[
            ...
            Field(
                description="(Optional) A filter for types   - AUTOASSIGNED: Domain like <appName>-<orgName>.koyeb.app"
            ),
        ] = None,
        statuses: Annotated[
            Optional[List[StrictStr]],
            Field(description="(Optional) A filter for statuses"),
        ] = None,
        app_ids: Annotated[
            Optional[List[StrictStr]], Field(description="(Optional) A filter for apps")
        ] = None,
        name: Annotated[
        ...
        ids: Annotated[
            Optional[List[StrictStr]],
            Field(description="(Optional) Filter on domain ids"),
        ] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    async def refresh_domain_status_with_http_info(
        self,
        id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def refresh_domain_status_without_preload_content(
        self,
        id: StrictStr,
        _request_timeout: Union[
            None,
